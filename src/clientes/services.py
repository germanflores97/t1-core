...
def crear_cliente(cliente: CrearClienteRequest) -> Tuple[bool, CrearClienteResponse]:
    """
        ...
        registro, el segundo parametro es la respuesta del servicio.
        </p>
    """
    ...
    cliente_id = clientes_repository.crear_cliente(
        Cliente(
    ...
    return True, CrearClienteResponse(id=str(cliente_id))
...
def actualizar_cliente(id:str, cliente: ActualizarClienteRequest) -> ActualizarClienteResponse:
    registros_actualizados = clientes_repository.actualizar_cliente(
        Cliente(
            _id=PyObjectId(id), nombres=cliente.nombres, apellido_paterno=cliente.apellido_paterno, apellido_materno=cliente.apellido_materno,
