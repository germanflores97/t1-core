...
def crear_tarjeta(request: CrearTarjetaRequest):
    """
        <p>
        <b>Importante</b>: En caso que el registro por numero_tarjeta y cliente_id no exista, se almacenara y se devolvera
        un HTTP Code 201 con el ID generado, en caso que ya exista con ambos criterios, simplemente se regresara un HTTP Code 200
